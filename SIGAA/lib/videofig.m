...
%   Joo Filipe Henriques, 2010
	...
	if nargin < 3 || isempty(play_fps), play_fps = 20; end  %play speed (frames per second)
    ...
    %set frame number title
    set(fig_handle, 'NumberTitle', 'off', ...
            'Name', sprintf('Frame: %s', int2str(f)));
